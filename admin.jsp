...
function validateLogin(){
	...
	var username = document.forms["loginpage"]["AID"].value;
	var password = document.forms["loginpage"]["password"].value;
	if(username==null || username==""){		
		document.getElementById("usererror").innerHTML="Admin ID Required";
...
<body>
<form name="loginpage" action="Validate" method="post">
<input type="hidden" name="fromwhere" value="loginpage">
<div id="section">
<table>
<tr>Admin ID  <input type="text" name="AID" style="font-size: 20px;"></input></tr>
